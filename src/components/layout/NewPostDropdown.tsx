    ...
    return (
      <DropdownMenu open={open} onOpenChange={setOpen}>
        <DropdownMenuTrigger asChild>
          <button
            className="fixed cursor-pointer bottom-6 right-10 z-50 w-20 h-16 rounded-2xl hover:scale-110 transition-transform-color duration-300 opacity-70 hover:opacity-100 bg-gradient-to-br from-indigo-500 to-purple-600 text-white flex items-center justify-center"
